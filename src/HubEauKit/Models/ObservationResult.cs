...
namespace HubEauKit.Models {
    /// <summary>Résultat d&apos;une rêquete sur les observations</summary>
    public class ObservationResult : IAdditionalDataHolder, IParsable {
        ...
        /// <summary>
        /// Instantiates a new ObservationResult and sets the default values.
        /// </summary>
        ...
        /// </summary>
        public static ObservationResult CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"data", n => { Data = n.GetCollectionOfObjectValues<Observation>(Observation.CreateFromDiscriminatorValue).ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<Observation>("data", Data);
