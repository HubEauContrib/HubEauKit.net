...
namespace HubEauKit.Models {
    /// <summary>Résultat d&apos;une rêquete sur les stations</summary>
    public class StationResult : IAdditionalDataHolder, IParsable {
        ...
        /// <summary>
        /// Instantiates a new StationResult and sets the default values.
        /// </summary>
        ...
        /// </summary>
        public static StationResult CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"data", n => { Data = n.GetCollectionOfObjectValues<Station>(Station.CreateFromDiscriminatorValue).ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<Station>("data", Data);
