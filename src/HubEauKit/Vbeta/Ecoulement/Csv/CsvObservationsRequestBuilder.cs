...
namespace HubEauKit.Vbeta.Ecoulement.Csv
{
    ...
    public class CsvObservationsRequestBuilder
    {
        ...
        /// </summary>
        public CsvObservationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter)
        {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        /// </summary>
        public CsvObservationsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter)
        {
