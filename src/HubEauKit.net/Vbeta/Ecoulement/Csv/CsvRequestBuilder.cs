...
//namespace HubEauKit.Vbeta.Ecoulement.Csv
//{
//    /// <summary>Builds and executes requests for operations under \vbeta\ecoulement\stations.csv</summary>
...
//        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
//        /// </summary>
//        public CsvRequestBuilder(string rawUrl, IRequestAdapter requestAdapter)
//        {
...
//        /// </summary>
//        public RequestInformation CreateGetRequestInformation(Action<CsvRequestBuilderGetRequestConfiguration> requestConfiguration = default)
//        {
...
//            {
//                var requestConfig = new CsvRequestBuilderGetRequestConfiguration();
...
//        /// </summary>
//        public async Task<Stream> GetStationsAsync(Action<CsvRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default)
//        {
...
//        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
//        /// </summary>
//        public async Task<Stream> GetAsync(Action<CsvRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default)
//        {
//            var requestInfo = CreateGetRequestInformation(requestConfiguration);
//            return await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo, responseHandler, default, cancellationToken);
//        }
//        /// <summary>Lister les stations au format CSV</summary>
//        public class CsvRequestBuilderGetQueryParameters
//        {
...
//        public class CsvRequestBuilderGetRequestConfiguration
//        {
...
//            public CsvRequestBuilderGetQueryParameters QueryParameters { get; set; } = new CsvRequestBuilderGetQueryParameters();
//            /// <summary>
//            /// Instantiates a new csvRequestBuilderGetRequestConfiguration and sets the default values.
//            /// </summary>
//            public CsvRequestBuilderGetRequestConfiguration()
//            {
